...
fips_data_file = (
    "/home/gray/src/work/al-btn/public/data/census"
    "/alabama-county-fips.json"
)
vax_data_file = (
    "/home/gray/src/work/al-btn/public/data/alabama"
    "/covid-19-vaccination-20210912-101600.csv"
)
...
with open(vax_data_file, "r") as f:
    vax_csv = csv.reader(f)
    csv_labels = [
        "county",
        "population",
        "one dose",
    ...
    for row in vax_csv:
        if row[0] == "County" or row[0] == "Alabama":
            continue
        vax_data.append(dict(zip(csv_labels, row + [get_fips(row[0])])))
